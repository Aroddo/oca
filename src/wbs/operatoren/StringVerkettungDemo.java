...
public class StringVerkettungDemo {
	public static void main(String[] args) {
		...
		System.out.println(n1 + " " + new Object()); // 3 java.lang.Object@10b62c9
		System.out.println(new Integer(3) * 3 + s1); // 9blabl
		System.out.println(1 + 2 + "drei"); // 3drei

		System.out.println("eins" + 2 + 3); // eins23
		System.out.println("eins" + 2 * 3); // eins6

		System.out.println(2 + 3 + "eins"); // 5eins
		System.out.println(2 * 3 + "eins"); // 6eins
